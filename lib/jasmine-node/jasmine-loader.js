(function() {
  var booter, contextObj, executeSpecsInFolder, fileFinder, fs, jasminejs, loadHelpersInFolder, loadJasmine, mkdirp, path, removeJasmineFrames, util, vm, _;
  ...
  executeSpecsInFolder = function(options) {
    var defaults, error, jasmine, jasmineEnv, spec, specsList, _i, _len;
